...
public class EmployeeManagementView extends BaseView{
	...
	protected void initialize() {
		...
		employeeIdField.setBorder(
				BorderFactory.createCompoundBorder(
						employeeIdField.getBorder(), 
	...
	protected void setCenter() {
		...
		for (Employee emp : employees) {
			Object[] rowData = {emp.getEmployeeID(), emp.getPositionID(), emp.getName(), emp.getStatus(), emp.getSalary(), emp.getUsername()};
		...
		if (e.getSource() == backBtn) {
			...
			if (employeeIdField.getText().isEmpty()) {
				...
				if (e.getSource() == updateBtn) {
					new UpdateEmployeeView(getSelectedEmployee());
					this.dispose();
